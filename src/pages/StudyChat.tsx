...
import { API_KEYS, SYSTEM_PROMPTS } from '../config/api-keys';
...
const StudyChat = () => {
  ...
  const callGroqAPI = async (prompt: string, apiKey: string, tutorName: 'TUTOR1' | 'TUTOR2') => {
    try {
      const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
        ...
        body: JSON.stringify({
          model: selectedModel,
          messages: [
            { role: 'system', content: SYSTEM_PROMPTS[tutorName] },
